...
//Envio de correos servidor
/*function sendEmail($data,$template){
    $mail = new PHPMailer(true);
    $mail->SMTPDebug = 0;
    $mail->isSMTP();
    $mail->Host  = 'apparelstore.clothing'; //este es tu servidor de correo, ej: gmail, hotmail, tu servidror, etc.
    $mail->SMTPAuth   = true;
    $mail->Username   = 'tiendavirtual@apparelstore.clothing'; //esta es tu cuenta a usar
    $mail->Password   = 'Tienda_1897'; //este es el password de tu cuenta
    $mail->SMTPSecure = 'ssl';
    $mail->Port       = 465;
    $mail->setFrom('tiendavinfo@gmail.com', 'Tienda Virtual');
...
$mail->SMTPAuth   = true;
$mail->Username   = 'tiendavinfo@gmail.com'; //esta es tu cuenta a usar
$mail->Password   = 'Tienda12345'; //este es el password de tu cuenta
$mail->SMTPSecure = 'tls';
$mail->Port       = 587;
$mail->setFrom('tiendavinfo@gmail.com', 'tiendavinfo');
$emailDestino = $data['email'];
$mail->addAddress($emailDestino);
$asunto = $data['asunto'];
$mail->isHTML(true);
