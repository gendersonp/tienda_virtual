...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="<?= media() ?>/tienda/images/tienda.ico"/>
<!--===============================================================================================-->
	  ...
	  <div class="modal-dialog modal-lg">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <p>APPAREL STORE ofrece entrega estándar, al día siguiente de realizar el pedido con un valor del envio de $3 !</p>
	        <br>
	        <p>Las compras en línea son válidas para cambio, crédito o reembolso dentro de los 30 días posteriores a la fecha de envío, ya sea a través de nuestro portal de devoluciones o en la tienda. Los intercambios de compra en línea solo están disponibles en la tienda. La confirmación de su pedido contiene un código de barras para facilitar su devolución y especifica el último día que tiene para devolver su mercancía por correo o en una de nuestras tiendas.

			Los artículos de venta final no se pueden devolver ni cambiar, a menos que lo exija la ley.

			Todos los artículos devueltos o cambiados deben estar sin lavar, sin usar y sin daños, con todas las etiquetas adjuntas. Las joyas deben estar en su empaque original. Todos los artículos devueltos deben ir acompañados del formulario de devolución y los documentos de aduana (si corresponde)!</p>
	      </div>
	...
	<header>
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						...
						<a href="<?= base_url() ?>/registro" class="flex-c-m trans-04 p-lr-25">
							Registrarse
						</a>
						<?php } ?>
					</div>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<a href="<?= base_url(); ?>" class="logo">
						<img src="<?= media() ?>/tienda/images/apparel.png" alt="Tienda Virtual">
					</a>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="<?= base_url(); ?>"><img src="<?= media() ?>/tienda/images/apparel.png" alt="Tienda Virtual"></a>
			</div>
