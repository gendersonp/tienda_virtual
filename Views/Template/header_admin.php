...
<html lang="es">
  <head>
    ...
    <meta name="author" content="Genderson Porras">
    <meta name="theme-color" content="#009688">
    <link rel="shortcut icon" href="<?= media();?>/images/tienda.ico">
  ...
  <body class="app sidebar-mini">
    ...
    <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard">Tienda Virtual</a>
      <!-- Sidebar toggle button--> <a class="app-sidebar__toggle" href="#" data-toggle="sidebar" ></i></a> 
      <!-- Navbar Right Menu-->
      <ul class="app-nav">
        <!-- User Menu-->
