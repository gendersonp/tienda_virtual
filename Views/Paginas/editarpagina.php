<?php 
    ...
    $fotoRemove = 0;
    $imgPortada = $fotoActual != "" ? '<img id="img" src="'.media()."/tienda/images/".$fotoActual.'">' : "";
?>
        ...
        <div class="row">
            <div class="col-md-12">
              ...
              ?>
                    ...
                    <form id="formPaginas" name="formProductos" class="form-horizontal">
                            <input type="hidden" id="idPost" name="idPost" value="<?= $data['infoPage']['contenido'] ?>">
                               ...
                               <p class="text-primary">Los campos con asterisco (<span class="required">*</span>) son obligatorios.</p>
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <textarea class="form-control" id="txtContenido" name="txtContenido" ><?= $data['infoPage']
                                        ['contenido'] ?></textarea>
                                        </div>
